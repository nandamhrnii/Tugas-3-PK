...
<body>
    <header>
        <div id="logo">
            <a href="logo pasuruan.png"><img src="logo pasuruan.png" alt="Logo Kabupaten Pasuruan" height="100px"></a>
        </div>
        <nav>
            <ul>
    ...
    <main>
        ...
        <section id="history">
            <div class="container">
                <div class="card p-5" width="100%">
                    <h2>Sejarah</h2>
                    <img src="Sejarah Kab.Pasuruan.jpg" alt="gambar pasuruan" width="100%" height="630px">
                    <br>
        ...
        <section id="tour">
            <div class="container">
                <div class="card p-5">
                    <h2>Wisata</h2>
                    <img src="Wisata Pasuruan.jpg" alt="gambar pasuruan" width="1000px" height="630px">
                    <br>
                    ...
                    <img src="Cimory Pasuruan.jpeg" alt="gambar pasuruan" width="1000px" height="630px"> <br>
                    ...
                    <img src="Bhakti Alam Pasuruan.jpg" alt="BA Pasuruan" width="1000px" height="630px"> <br>
                    ...
                    <img src="Kebun Raya Purwodadi.jpg" alt="KRP" width="1000px" height="630px"> <br>
